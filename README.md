...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-_darknet_mutex-green.svg)](https://anaconda.org/conda-forge/_darknet_mutex) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/_darknet_mutex.svg)](https://anaconda.org/conda-forge/_darknet_mutex) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/_darknet_mutex.svg)](https://anaconda.org/conda-forge/_darknet_mutex) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/_darknet_mutex.svg)](https://anaconda.org/conda-forge/_darknet_mutex) |

Installing _darknet_mutex
=========================

Installing `_darknet_mutex` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:

```
conda config --add channels conda-forge
```

Once the `conda-forge` channel has been enabled, `_darknet_mutex` can be installed with:
...
```
conda search _darknet_mutex --channel conda-forge
```
